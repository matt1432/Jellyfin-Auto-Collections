...
class TSPDT(ListScraper):
    ...
    def get_list(list_id: str, config: BasePluginConfig) -> PluginResult:  # pyright: ignore[reportUnusedParameter]
        ...
        return {
            "name": "TSPDT Top 1000 Greatest",
            "items": movies,
            "description": "Compiled from 16,000+ film lists and ballots, The TSPDT 1,000 Greatest Films is quite possibly the most definitive collection of the most critically acclaimed films you will find.",
        }
